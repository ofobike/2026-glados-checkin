...
| 写法 | 说明 |
|------|------|
| `生日:1995-06-09` | 公历生日，每年提醒，并自动显示出生年月、属相和届时几岁 |
| `生日:06-09` | 公历生日，每年提醒，但不计算岁数 |
| `自己农历生日:lunar:1995-08-20` | 农历生日，每年换算到对应阳历日期，并自动显示出生年月、属相和届时几岁 |
| `农历生日:lunar:08-20` | 农历生日，每年提醒，但不计算岁数 |
| `结婚纪念日:11-18` | 每年重复倒数日，只倒计时，不自动算周年 |
| `域名到期:2026-12-31` | 固定公历日期，到期后显示已过去天数 |

> 💡 只有事件名里包含“生日”才会自动计算岁数；带出生年份的生日会自动显示出生年月和属相。其他日期不会误算“几岁”或“周年”。农历日期支持 `1900-2100` 年，闰月可写成 `农历生日:lunar:1995-闰8-20`。
...
🗓 倒数日:
🎂 生日提醒:
  自己、媳妇生日：出生 1992年02月，属猴；农历2027年02月01日 / 阳历2027年03月08日，35 岁，还有 273 天
  ... 还有 2 组生日已收起，最近一组还有 310 天

📅 重要日期:
  结婚纪念日：11月18日，还有 163 天
```
